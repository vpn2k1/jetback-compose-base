...
class ExpenseJournalViewModel(
    ...
    private fun runSyncAction(
        ...
        action: suspend () -> com.namvu.myapplication.expense.domain.usecase.ExpenseJournal,
    ) {
    ...
    private fun buildPreview(
        parsed: com.namvu.myapplication.expense.domain.model.ParsedExpenseInput,
    ): QuickExpensePreview? {
    ...
    private fun buildTemplates(
        expenses: List<com.namvu.myapplication.expense.domain.model.Expense>,
        categories: List<com.namvu.myapplication.expense.domain.model.Category>,
